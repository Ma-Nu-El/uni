...
Suponga que a un restaurant de comida rápida llegan 100 clientes por hora, la capacidad de atención es en promedio 150 clientes por hora. Si se sabe que cada cliente en promedio espera 2 minutos en cola

Calcule las medidas de desempeño del sistema

1. ¿Cuál es la probabilidad que el sistema este vacío?
2. ¿Cuál es la probabilidad que un cliente llegue y que tenga que esperar porque el sistema está ocupado?
