...
aproximadamente call_labor_in_queue_approx() {{{results(=4=)}}}
...
#+begin_src R :session :exports both :var clients=number_of_clients_in_system_4 :results silent
clients_adjusted<-clients-1
r<-usage_factor
1-sum(probability_of_n_clients_in_system<-(1-r)*(r^(0:clients_adjusted)))
#+end_src
...
acudir al cajero en cualquier momento
