...
- [[#determinación-r2][Determinación (R^2)]]
- [[#construcción-y-calidad-del-modelo][Construcción y calidad del modelo]]
- [[#supuestos-para-la-realización-de-un-modelo-rlm-rls][Supuestos para la realización de un modelo RLM (RLS)]]
- [[#condición-de-cálculo][Condición de cálculo]]
- [[#simulaciones][Simulaciones]]
- [[#método-de-mínimos-cuadrados-ordinariosmmco][Método de Mínimos Cuadrados Ordinarios(MMCO)]]
- [[#notas-de-la-clase][Notas de la clase]]
- [[#scripts-usados][Scripts usados]]
- [[#consulta-al-profe][Consulta al profe]]
- [[#libros][Libros]]
